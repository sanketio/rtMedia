			...
			<div id="rtmedia-single-media-container"
				...
				<?php if ( ! $rt_ajax_request ){ ?>
					...
					<div class="rtmedia-media"
						 id="rtmedia-media-<?php echo rtmedia_id(); ?>"><?php rtmedia_media( true ); ?></div>

				<?php } else { ?>

					<button class="mfp-arrow mfp-arrow-left mfp-prevent-close rtm-lightbox-arrows" type="button"
							title="Previous Media"></button>
					<button class="mfp-arrow mfp-arrow-right mfp-prevent-close" type="button"
							title="Next Media"></button>
					<!--author actions-->
					<div class='rtm-ltb-title-container rt-clear'>
						<h2 class='rtm-ltb-title'>
							<a href="<?php echo rtmedia_permalink(); ?>"
							   title="<?php echo rtmedia_title(); ?>"><?php echo rtmedia_title(); ?></a>
						</h2>
					...
					<div class='rtm-ltb-action-container rt-clear'>
						<div class="rtm-ltb-gallery-title"><span class='ltb-title'></span><span
								class='media-index'></span><span class='total-medias'></span></div>
								...
								<div class="large-12 columns">
									<div class='rtmedia-actions-before-comments'>
										...
										<?php if ( is_user_logged_in() ){ ?>
											<span><a href='#'
													 class='rtmedia-comment-link'><?php _e( 'Comment', 'rtmedia' ); ?></a></span>
										<?php } ?>
									</div>
