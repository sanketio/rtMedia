		...
		while ( $offset < $datalength ) {
			...
			switch ( $record_type ) {
				...
				case 0x02000023: // PictureControlData
					...
					$data                 = array(
						'PictureControlVersion' => substr( $data, 0, 4 ), 'PictureControlName' => rtrim( substr( $data, 4, 20 ), "\x00" ), 'PictureControlBase' => rtrim( substr( $data, 24, 20 ), "\x00" ), //'?'                       =>                           substr($data, 44,  4),
