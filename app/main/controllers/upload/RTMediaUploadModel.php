...
class RTMediaUploadModel
{
	...
	function sanitize_object() {
		...
		if ( ! is_array( $this->upload[ 'taxonomy' ] ) ) $this->upload[ 'taxonomy' ] = array( $this->upload[ 'taxonomy' ] );

		if ( ! is_array( $this->upload[ 'custom_fields' ] ) ) $this->upload[ 'custom_fields' ] = array( $this->upload[ 'custom_fields' ] );

		if ( ! $this->has_album_id() || ! $this->has_album_permissions() ) $this->set_album_id();

		if ( ! $this->has_author() ) $this->set_author();
