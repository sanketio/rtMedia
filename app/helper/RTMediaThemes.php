...
class RTMediaThemes
{
	...
	public function get_themes()
	{
		...
		$tabs[ ] = array( 'title' => __( 'rtMedia Themes By rtCamp', 'rtmedia' ), 'name' => __( 'rtMedia Themes By rtCamp', 'rtmedia' ), 'href' => '#rtmedia-themes', 'callback' => array( $this, 'rtmedia_themes_content' ) );
		$tabs[ ] = array( 'title' => __( '3rd Party Themes', 'rtmedia' ), 'name' => __( '3rd Party Themes', 'rtmedia' ), 'href' => '#rtmedia-themes-3', 'callback' => array( $this, 'rtmedia_3rd_party_themes_content' ) );
		?>
		<div id="rtm-themes">
	...
	function rtmedia_themes_content()
	{
		...
		<div class="row">
			<div class="columns large-12">
				<div class="columns large-4 rtmedia-theme-image"><a href="https://rtcamp.com/store/inspirebook/"
																	target="_blank"><img
							src="<?php echo RTMEDIA_URL . 'app/assets/img/rtmedia-theme-InspireBook.png' ?>"/></a></div>
				<div class="columns large-7 rtmedia-theme-content">
					...
					<div>
						...
						<p>
							<span>InspireBook is a premium WordPress theme, designed especially for BuddyPress and rtMedia powered social-networks. <a
									href="https://rtcamp.com/introducing-inspirebook/" class="rtmedia-theme-inner-a"
									target="_blank">Read More</a> </span>
						</p>

						<p>
							<span>Links: <a href="https://rtcamp.com/store/inspirebook/" target="_blank">Buy
									InspireBook</a> | <a href="http://demo.rtcamp.com/rtmedia/?theme=InspireBook"
														 target="_blank">Live Demo</a> | <a
									href="https://rtcamp.com/docs/inspirebook/" target="_blank">Documentation</a> | <a
									href="https://rtcamp.com/support/forum/premium-themes/" target="_blank">Support
									Forum</a></span>
						</p>
					</div>
				</div>
	...
	function rtmedia_3rd_party_themes_content()
	{
		...
		<hr>
		<div class="row">
			<div class="columns large-4 rtmedia-theme-image"><a href="http://rt.cx/sweetdate" target="_blank"><img
						src="<?php echo RTMEDIA_URL . 'app/assets/img/rtmedia-theme-sweetdate.png' ?>"/></a></div>
			<div class="columns large-7">
				<h3 class="rtmedia-theme-3rd-party-title"><a href="http://rt.cx/sweetdate" target="_blank">Sweet
						Date</a></h3>
		...
		<hr>
		<div class="row">
			<div class="columns large-4 rtmedia-theme-image"><a href="http://rt.cx/kleo" target="_blank"><img
						src="<?php echo RTMEDIA_URL . 'app/assets/img/rtmedia-theme-kleo.png' ?>"/></a></div>
			<div class="columns large-7">
